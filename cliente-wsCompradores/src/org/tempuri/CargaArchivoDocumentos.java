 ...
 *         &lt;element name="ArchivoDocumentosNombre" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    ...
    "password",
    "fecha",
    "archivoDocumentosNombre",
    "bytes"
})
@XmlRootElement(name = "CargaArchivoDocumentos")
public class CargaArchivoDocumentos {
    ...
    @XmlElementRef(name = "ArchivoDocumentosNombre", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> archivoDocumentosNombre;
    ...
    /**
     * Obtiene el valor de la propiedad archivoDocumentosNombre.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getArchivoDocumentosNombre() {
        return archivoDocumentosNombre;
    }

    /**
     * Define el valor de la propiedad archivoDocumentosNombre.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setArchivoDocumentosNombre(JAXBElement<String> value) {
        this.archivoDocumentosNombre = value;
    }
